...
const UploadProduct = () => {
  ...
  const handleDeleteImage = async(index)=>{
      // FIXED: Avoided direct mutation
      setData((preve)=>{
        const newList = [...preve.image]
  ...
  const handleRemoveSubCategory = async(index)=>{
      // FIXED: Avoided direct mutation
      setData((preve)=>{
        const newList = [...preve.subCategory]
        newList.splice(index,1)
        return{
          ...preve,
          subCategory : newList
  ...
  const handleSubmit = async(e)=>{
    ...
    // FIXED: Convert Category and SubCategory objects to ID arrays for MongoDB
    const payload = {
        ...data,
                  ...
                  <div>
                    <select
                      ...
                      onChange={(e)=>{
                        ...
                        // FIXED: Added check to prevent duplicates
                    ...
                    <div className='flex flex-wrap gap-3'>
                      {
                        data.category.map((c,index)=>{
                          return(
                            <div key={c._id+index+"productsection"} className='text-sm flex items-center gap-1 bg-blue-50 mt-2 px-2 py-1 rounded'>
                              <p>{c.name}</p>
