    ...
    <div className='bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-100 min-h-screen transition-colors pb-24'>
      ...
      {(role === "ADMIN" || role === "SUPER_ADMIN") && (
        <>
          ...
          <Link to={"/dashboard/rider-fleet?tab=applications"} className='px-3 py-2.5 rounded-xl bg-teal-50 dark:bg-teal-950/40 hover:bg-teal-100 dark:hover:bg-teal-900/50 font-bold text-teal-800 dark:text-teal-300 border-l-4 border-teal-500 transition-colors flex items-center justify-between'>
      ...
      <Link to={"/refer"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        Refer &amp; Earn
      </Link>
      <Link to={"/wallet"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        Wallet
      </Link>
      <Link to={"/wishlist"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        My Wishlist
      </Link>
      <Link to={"/deals"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        All Deals &amp; Offers
      </Link>
      <Link to={"/snapit-plus"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        Snapit Plus Membership
      </Link>
      <Link to={"/streak"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        Daily Streak &amp; Rewards
      </Link>
      <Link to={"/subscriptions"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        My Subscriptions
      </Link>
      ...
      >
        ...
        <span className='text-xs bg-amber-200 dark:bg-amber-800 text-amber-950 dark:text-amber-100 px-2.5 py-0.5 rounded-full font-black'>
          5★ Review
        </span>
      </button>
      <Link to={"/privacy-policy"} className='px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium transition-colors'>
        Privacy Policy
      </Link>
