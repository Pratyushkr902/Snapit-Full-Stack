...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    // FIXED: Added try/catch and safe checks to prevent React from crashing
    const handleUploadCategoryImage = async(e)=>{
        ...
        try {
            ...
            if (imageUrl) {
                ...
                toast.error("Failed to get image URL. Check server/Cloudinary.")
            }
        } catch (error) {
            console.error("Upload failed", error)
            toast.error("Image upload crashed. Is your server running?")
        }
    }
