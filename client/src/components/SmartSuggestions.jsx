          ...
          return (
            ...
            >
              <div className='w-full aspect-square bg-gray-50 rounded-2xl flex items-center justify-center relative overflow-hidden p-3 border border-gray-100/60 shadow-sm'>
                ...
                <button onClick={(e) => e.stopPropagation()} className='absolute top-2 right-2 text-rose-400 bg-white p-1 rounded-full shadow-sm'>
                  <FaHeart size={12} />
                </button>
                ...
                <button
                  ...
                  className='absolute bottom-2 left-1/2 transform -translate-x-1/2 bg-white border border-rose-500 text-rose-500 font-extrabold text-xs px-5 py-1 rounded-lg shadow-sm uppercase tracking-wider'
                >
                  Add
                </button>
              </div>
