...
async function runUrgentFreeDeliveryBroadcast() {
  console.log('⚡ Starting Urgent Last-Chance FREE Delivery Broadcast...')
  await connectDB()

  const title = '⚡ HURRY! Last 15 Mins: 100% FREE Delivery! 🛵💨'
  const shayari = 'सिर्फ 15 मिनट बाकी हैं, 8:30 PM पर बंद हो जाएगा स्टोर!\nमुफ्त डिलीवरी का फायदा उठाएं, देर ना करें अब और! ⏰🎁'
  const body = '🚨 Last chance for tonight! Flat 100% FREE Delivery on orders ₹149+ in Paliganj & ₹199+ at Campus. Shutter closes sharp at 8:30 PM IST. Tap to order your dinner now!'
  ...
  console.log(`📱 Prepared ${allTokens.length} unique device tokens for urgent push blast!`)
  ...
  console.log('\n=============================================')
  console.log('🎉 URGENT FREE DELIVERY BROADCAST COMPLETED!')
...
runUrgentFreeDeliveryBroadcast().catch(err => {
  console.error('❌ Urgent Free Delivery Broadcast Failed:', err)
  process.exit(1)
})
