...
const checkDeliveryServiceability = (lat, lng) => {
  ...
  if (dist > 5 && isAfterEveningCutoff()) {
    return `Deliveries to locations beyond 5 km are closed after 10:30 PM for rider safety (${dist.toFixed(1)} km away). Please select an address within 5 km or order tomorrow morning!`
  }
  return null
}
