...
export const getAppVersionController = async (req, res) => {
  try {
    return res.status(200).json({
      ...
      error: false,
      data: {
        latestVersion: "2.6.41",
        latestVersionCode: 80,
        minRequiredVersionCode: 80,
        forceUpdate: false,
        ...
        message: "A new version of Snapit (v2.6.41) is ready with 365-day persistent login and Up to 60% OFF coupon engine!",
        releaseNotes: [
